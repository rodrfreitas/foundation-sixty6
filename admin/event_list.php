...
$stmt = $connection->prepare('SELECT id,title FROM events ORDER BY id
ASC'); $stmt->execute(); ?> -->
  ...
  <body id="body-project-list">
    <section class="grid-con admin-dashboard">
      ...
      <div class="col-span-full m-col-start-5 m-col-end-12 list-Projects">
          ...
          <h3 class="newProject"><a href="#lightbox"><span>+&nbsp;</span> Add a New Event</a></h3><br>
          ...
          <div class="actionsList">
            ...
            foreach ($rows as $row) {
                echo '<p>' .
                    '<a class="edit" href="edit_event_form.php?id=' . $row['id'] . '"><i class="fa fa-edit"></i>Update</a>' .
                    '<span class="separator"> | </span>' . 
                    '<a class="delete" href="delete_event.php?id=' . $row['id'] . '"><i class="fa fa-trash"></i>Delete</a>' .
                    '</p>';
            }
            ?>
         </div>
    ...
    <section class="lightbox" id="lightbox">
      ...
      <div>
        ...
        <form class="projectLightbox"action="add_event.php" method="post" enctype="multipart/form-data">
          <label for="title">Title: </label>
          <input name="title" type="text" required /><br /><br />

          <label for="thumb">Thumbnail:</label>
          <input type="file" name="thumb" id="uploaded"><br><br />
